...
public class MenuController {
    ...
    public ResponseEntity<List<MenuItemResponse>> getActiveMenus(@RequestParam(value = "sortByColumn", defaultValue = "name") String sortByColumn,
        ...
        List<MenuItemResponse> activeMenus = menuService.getActiveMenus(shopId,sortRequest);
